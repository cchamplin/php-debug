...
render () {
    ...
    return <li className="php-debug-stack-item" onclick={this.handleClick}>
        ...
        <div className='stack-frame-line text-smaller inline-block-tight badge badge-smal' data-line={frame.line}>{frame.line}</div>
      </li>
  }
  handleClick () {
