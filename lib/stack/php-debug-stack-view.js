  ...
  render () {
    ...
    if (frames.length) {
      return <div className='php-debug-stack-view pane-item native-key-bindings' style="overflow:auto;" tabindex='-1'>
                <ul className='php-debug-stacks php-debug-contents native-key-bindings php-debug-list'>
                {frames}
                </ul>
            </div>
    } else {
    return <div className='php-debug-stack-view pane-item padded native-key-bindings' style="overflow:auto;" tabindex='-1'>
              <ul className='php-debug-stacks php-debug-contents native-key-bindings php-debug-list'>
              </ul>
          </div>
        }
